...
<html>
	...
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
	<script src="{{ ('assets/frontend/js/respond.min.j')}}s"></script>
	<![endif]-->
					...
					<div class="col-md-3">
						<div class="side animate-box">
							...
							<div class="fh5co-staff">
								<img src="assets/frontend/images/user-2.jpg" alt="Free HTML5 Templates by FreeHTML5.co">
								<h3>Jean Smith</h3>
	...
	<!-- Waypoints -->
	<script src="{{ ('assets/frontend/js/jquery.waypoi')}}nts.min.js"></script>
	<!-- Flexslider -->
	<script src="{{ ('assets/frontend/js/jquery.flexsl')}}ider-min.js"></script>
	<!-- Magnific Popup -->
	<script src="{{ ('assets/frontend/js/jquery.magnif')}}ic-popup.min.js"></script>
	<script src="{{ ('assets/frontend/js/magnific-popu')}}p-options.js"></script>
	<!-- Main -->
	<script src="{{ ('assets/frontend/js/main.js"></sc')}}ript>
